...
public class NhanVienPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Combobox_Search.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã Nhân Viên", "Tên", "Chức Vụ", "Tài Khoản", "Số Điện Thoại" }));
    ...
    private void jlbXoaMouseEntered(java.awt.event.MouseEvent evt) {                                    
        jlbXoa.setIcon(new ImageIcon(getClass().getResource("../img/icon/xoa-hover.png")));
    }                                   

    private void jlbXoaMouseExited(java.awt.event.MouseEvent evt) {                                   
        jlbXoa.setIcon(new ImageIcon(getClass().getResource("../img/icon/xoa.png")));
    }                                  

    private void jlbSuaMouseEntered(java.awt.event.MouseEvent evt) {                                    
        jlbSua.setIcon(new ImageIcon(getClass().getResource("../img/icon/sua-hover.png")));
    }                                   

    private void jlbSuaMouseExited(java.awt.event.MouseEvent evt) {                                   
        jlbSua.setIcon(new ImageIcon(getClass().getResource("../img/icon/sua.png")));
    }                                  

    private void jbtThemMouseClicked(java.awt.event.MouseEvent evt) {                                     
    ...
    private void jbtThemMouseEntered(java.awt.event.MouseEvent evt) {                                     
        jbtThem.setIcon(new ImageIcon(getClass().getResource("../img/icon/them-hover.png")));
    }                                    

    private void jbtThemMouseExited(java.awt.event.MouseEvent evt) {                                    
    ...
    private void Combobox_SearchActionPerformed(java.awt.event.ActionEvent evt) {                                                

    }                                               

    private void DanhSachNhanVienMouseClicked(java.awt.event.MouseEvent evt) {                                              
        hienThiChiTietNhanVien();
    }                                             

    private void DanhSachNhanVienKeyReleased(java.awt.event.KeyEvent evt) {                                             
        if (evt.getKeyCode() == KeyEvent.VK_UP || evt.getKeyCode() == KeyEvent.VK_DOWN) {
            hienThiChiTietNhanVien();
        }
    }                                            

    private void jlbXoaMouseClicked(java.awt.event.MouseEvent evt) {                                    
    ...
    private void jlbSuaMouseClicked(java.awt.event.MouseEvent evt) {                                    
        if (DanhSachNhanVien.getSelectedRow() != -1) {
    ...
    private void SearchMouseClicked(java.awt.event.MouseEvent evt) {                                    
        ...
        if (Search_Text.getText().equals("")) {
            ...
            if (Combobox_Search.getSelectedIndex() == 0) {
                ...
                NhanVienBus.dsnv = nvb.timNhanVienTheoChucVu(Search_Text.getText());
            }else if(Combobox_Search.getSelectedIndex() == 3){
                NhanVienBus.dsnv = nvb.timNhanVienTheoTaiKhoan(Search_Text.getText());
            }else{
                NhanVienBus.dsnv = nvb.timNhanVienTheoSDT(Search_Text.getText());
            }
        }
        hienThiDanhSachNhanVien();
    }                                   
